...
class UserRegisterControllerTest {
    ...
    void setUp() {
      ...
      class rightFormInputs {
        ...
        void existUserId() throws Exception {
          doThrow(new ExistUserException("エラーメッセージ")).when(service).confirmAvailability("userId");
  ...
  class testCompleteRegister {
    ...
    void failureRegister() throws Exception {
      ...
      when(service.register((User) Mockito.any())).thenThrow(DataAccessResourceFailureException.class);
